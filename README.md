...
In the specific case of software engineering, there are no apparent metrics that follow the logic of the examples above that are useful (TechBeacon, 2020). The transparent nature of software engineering allows managers to collect an abundance of metrics on their teams and team members. Such metrics include the number of pull requests merged in a period, the number of customer issues addressed by on-call engineers in a period and the number of tickets submitted by an engineer or engineering team in a period. While these kinds of metrics can be somewhat useful in measuring the number of things a software engineering team or individual software engineer are doing, they are not always the most unambiguous indication of performance. The goal of this report is to discuss why this traditional logic when selecting metrics does not work and provide some examples of modern measurement frameworks that empower engineers and managers to collaborate effectively to improve productivity. This report will also examine case studies of products that have been developed to measure software engineers and analyse the ethical implications of these tools.  
...
#### Ethical Concerns
Waber has stressed that people opt into wearing Humanyze badges and that representatives from the company "go in and talk to employees about what data we collect, that we don't share it, that it's anonymous and not about recording your bathroom breaks. It's a legal contract that people choose to sign" (HR Magazine, 2020). Waber has also stated that anyone who is uncomfortable with the concept and does not opt into the monitoring service is given a fake badge so that none of the other employees knows. This raises a sinister question; if this is a contract that people choose to sign, why is there a need for fake badges? These scenarios that are disguised as opt-in services end up being non-negotiable company-wide changes that employees are forced to adopt. This practice raises ethical concerns; is it appropriate for companies to force their employees to opt-in to second by second monitoring?  

The critical ethical issue with Humanyze badges is their lack of intelligence. They are not sophisticated enough to distinguish between personal and professional conversations; they are programmed to monitor employees at all times throughout the day. Thus, regardless of whether it is intentional or not, private discussions and actions are recorded and sent to Humanyze for analysis. This raises an abundance of ethical issues; is it appropriate for a company to monitor the number of americanos that an employee consumes in a day? Is it suitable for a company to analyse water-cooler conversation about weekend barbecues? It makes sense for a company to attempt to maximise the productivity of their employees, but is it ethical to do so at the cost of the employees' privacy? These practices can be likened to those of "Big Brother" in George Orwell's novel, "1984" and disrespect the civil liberties of employees, specifically concerning mass surveillance. This question of ethics is only made more complicated when the case of a data leak is introduced, and potentially thousands of hours of private conversations are stolen. Regardless of its well-meaning intentions, the ethical implications of this product prove to be insurmountable, as Weber himself admitted that the "Big Brother image is a big obstacle in getting people to adopt the badge concept" (Business Insider, 2016). 

### Case Study #2: Code Climate
#### What is it?
Code Climate is an engineering intelligence platform that allows software development teams to accurately diagnose where work gets stuck, who needs help, and where the most significant opportunities lie for continuous improvement (Code Climate, 2020). The Code Commit platform is built on an open-source suite of static analysis engines and algorithms. As a result, individual contributors can develop their own engines that are capable of analysing projects written in any language of their choice, and the Code Climate team often extends these engines to all of its customers through their cloud-based analysis portal. The Code Climate platform has Github integration and analyses the quality of code in pull requests to make the process of merging them much simpler and quicker. The transparent nature of this analysis allows software engineers to understand exactly how their code is being evaluated. Code Climates main goals include:
- Finding a company's most significant slowdowns in the software development process by pinpointing exactly where pull requests get stuck on the journey from open to deployed.
- Distinguishing productive work patterns to understand the workflow of engineers and when it is best to help or avoid interrupting them.
- Providing reliable, objective metrics to give teams the foresight to ensure process changes truly improve how the team functions.  

One of the most popular Code Climate features is the test coverage that it supports. There are many open-source tools on the market that provide total test coverage metrics, but Code Climate offers additional features that show how much of the new code being added is not tested. This ensures that software engineers are testing their code changes properly and writing robust software. Code Climate also measures engineering health across entire organisations and calculates team velocity towards a Sprint goal. Code Climate focusses on using objective metrics in context to measure the performance of software engineering teams and give feedback on changes in development processes (Code Climate, 2020).  

#### Is it ethical?
Code Climate is an entirely ethical platform that provides transparent measurement techniques that analyse the quality of work submitted by engineers, rather than monitoring the actions and conversations that they have at all times. The main reason this process is so ethical is that the analysis suites are open source; the measurement process is not being hidden from software engineers. They have insight into what is being measured and are encouraged to write quality code that makes an impact on the progress of a project. The difference in ethical implications of this platform and the previous one discussed is stark; Code Climate empowers engineers to reach their full potential in a way that suits their needs instead of discouraging them from leaving their desk all day.  

## Conclusion
The first section of this paper discussed the use of traditional metrics to measure the performance of software engineering teams and individuals. The critical issue with these metrics is that lazy software engineers can easily manipulate them to make it look like they are being much more productive than they actually are. This is particularly an issue in smaller companies where managers have less technical knowledge, and they do not discover the lack of progress of individual engineers until it is too late.  

The second section of this paper explained different measurement frameworks that empower software engineers to collaborate in an effective manner. These new measurement frameworks thrive in the Agile Development Method and are paving the way for effective teams in the tech industry. These metrics and techniques involve the entire team so that they can be as accurate as possible and allow engineers to drive overall projects and features.  

Finally, this paper analysed two companies approaches to providing measurement tools for software engineering teams. The first company, Humanyze, raises many ethical questions that propels the modern tech industry in a dystopian, Orwellian direction. The second company, Code Climate, is committed to empowering software engineers to be more productive and effective by analysing their work and providing objective metrics on its quality. It is this line of measurement, that puts an emphasis on empowering engineers rather than looking over their shoulder, that will drive the software industry into a bright, productive future.  
...
Code Climate, 2020. Engineering Metrics to Improve Continuous Delivery Practices | Velocity. [Online]  
